...
exports.categoryHasAssignSubCategory = exports.categoryHasAssingProduct = exports.show = exports.index = void 0;
...
const categoryHasAssingProduct = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const results = yield category_service_1.userCategoryService.categoryHasAssingProduct({
            _id: new mongoose_1.Types.ObjectId(id),
        });
        res.status(200).json({
            status: true,
...
const categoryHasAssignSubCategory = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const results = yield category_service_1.userCategoryService.categoryHasAssignSubCategory({
            _id: new mongoose_1.Types.ObjectId(id),
        });
        res.status(200).json({
            status: true,
...
exports.categoryHasAssignSubCategory = categoryHasAssignSubCategory;
