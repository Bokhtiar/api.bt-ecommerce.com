...
const index = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const results = yield order_service_1.userOrderService.findAll({
...
const store = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userID = req.user.id;
        /* available cart */
        const availableCart = yield cart_service_1.cartService.findAll({
            _id: new mongoose_1.Types.ObjectId(userID),
        });
        ...
        yield order_service_1.userOrderService.orderCreate({
