...
const subCategoryController = __importStar(require("../../controllers/admin/subCategory.controller"));
const subCategory_validators_1 = require("../../validators/admin/subCategory.validators");
