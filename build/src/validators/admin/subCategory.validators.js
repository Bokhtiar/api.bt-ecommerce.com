...
exports.SubCategoryCreateUpdate = void 0;
...
const SubCategoryCreateUpdate = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const descriptor = {
        category: [
            {
                type: "string",
...
exports.SubCategoryCreateUpdate = SubCategoryCreateUpdate;
